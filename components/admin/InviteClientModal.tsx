        ...
        <div className="space-y-4 px-6 py-5">
          ...
          <div ref={dropdownRef} className="relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-lg border border-gray-200 py-2.5 pl-10 pr-3 text-sm outline-none focus:border-[#C9A84C] focus:ring-2 focus:ring-[#C9A84C]/20"
              />
            </div>
                ...
                {filteredClients.length === 0 ? (
                  ...
                  filteredClients.map((client) => (
                    <button
                      ...
                      className="flex w-full items-center justify-between px-4 py-2.5 text-left hover:bg-[#f5f3ee]"
                    >
                      <div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-200 px-4 py-2.5 text-sm outline-none focus:border-[#C9A84C] focus:ring-2 focus:ring-[#C9A84C]/20"
            />
          </div>
        ...
        <div className="flex items-center justify-end gap-3 border-t border-gray-100 px-6 py-4">
          ...
          {status !== "success" && (
            <button
              ...
              disabled={!canInvite}
              className="flex items-center gap-2 rounded-lg bg-[#0B1D3A] px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-[#1e3a5f] disabled:opacity-40"
            >
              {status === "loading" ? (
                <>
