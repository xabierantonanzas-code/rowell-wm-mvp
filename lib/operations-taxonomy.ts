...
export const PLUS_TYPES = new Set([
  ...
  "SUSC.TRASPASO EXT.",
  "RECEPCION IIC LIBRE PAGO", // PEND-017 (Edgard 2026-06-15): entrada de capital en especie
]);
...
export const NEUTRO_TYPES = new Set([
  ...
  "SUSCRIPCION FUSION CON IMPACTO FISCAL", // PEND-017 (Edgard 2026-06-15)
  "REEMBOLSO FUSION CON IMPACTO FISCAL", // PEND-017 (Edgard 2026-06-15)
  "SUSC.TRASPASO. INT.",
